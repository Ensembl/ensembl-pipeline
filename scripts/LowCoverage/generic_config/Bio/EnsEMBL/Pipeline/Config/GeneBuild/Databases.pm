...
%Databases = (
	      ...
	      # database containing the genewise genes (TGE_gw,similarity_genewise)
              GB_GW_DBHOST               => $LC_DBHOST,
              GB_GW_DBNAME               => $LC_DBprefix."GeneWise",
              GB_GW_DBUSER               => $LC_DBUSER,
              GB_GW_DBPASS               => $LC_DBPASS,
              GB_GW_DBPORT               => $LC_DBPORT,
	      ...
	      # database where the combined_gw_e2g genes will be stored
              GB_COMB_DBHOST             => $LC_DBHOST,
	      GB_COMB_DBNAME             => $LC_DBprefix."Combined",
	      GB_COMB_DBUSER             => $LC_DBUSER,
	      GB_COMB_DBPASS             => $LC_DBPASS,
	      GB_COMB_DBPORT             => $LC_DBPORT,
	      ...
	      # be run at the same time
              GB_cDNA_DBHOST             => $LC_DBHOST,
	      GB_cDNA_DBNAME             => $LC_DBprefix."hum_cDNA",
	      GB_cDNA_DBUSER             => $LC_DBUSER,
	      GB_cDNA_DBPASS             => $LC_DBPASS,
	      GB_cDNA_DBPORT             => $LC_DBPOR,
	      ...
	      GB_FINALDBUSER             => $LC_DBUSER,
	      GB_FINALDBPASS             => $LC_DBPASS,

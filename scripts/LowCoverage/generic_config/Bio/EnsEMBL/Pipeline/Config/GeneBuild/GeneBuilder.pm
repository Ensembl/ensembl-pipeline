...
%GeneBuilder = (
  ...
  # GB_MISC_OTHER_INPUT_GENETYPES => ['sim_gw_recovered',
  #                                  'sim_genewise_vert',
  #                                  'sim_genewise_mam70',
  #                                  ], # other gene-types which have to be combined / fetched (in GB_COMB_DBNAME)

  GB_MISC_OTHER_INPUT_GENETYPES => [ ], # other gene-types which have to be combined / fetched (in GB_COMB_DBNAME)
  ...
  GB_ABINITIO_PROTEIN_EVIDENCE => ['Uniprot_mammal'],
  ...
  # Keep everything in second round
  GB_MAXSHORTINTRONLEN    => -1, 

...
#
	      ...
	      EST_EXONERATE => {'VERSION' => '/usr/local/ensembl/bin/exonerate-0.8.2',
	      ...
	      REJECT_POTENTIAL_PROCESSED_PSEUDOS => 1,
	      ...
	      EST_EXONERATE_ANALYSIS    => "cdna_exonerate",
	     );

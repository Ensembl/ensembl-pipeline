...
%LowCoverageGeneBuildConf = (
	 	...
	 	# User-specific configuration:
		  ...
		  LC_PERL5LIB			=> '', #/nfs/acari/ba1/PerlCode/ensembl-config/armadillo/arma_1.0:/nfs/acari/ba1/PerlCode/ensembl/modules:/nfs/acari/ba1/PerlCode/ensembl-pipeline/modules:/nfs/acari/ba1/PerlCode/ensembl-analysis/modules:/nfs/acari/ba1/PerlCode/bioperl-0.7.1
		  ...
		  LC_AB_INITIO_LIB      => '', #/ecs4/work3/ba1/test/repeat_libraries/ab_initio.lib
		  LC_SUPP_LIB           => '', #/ecs4/work3/ba1/test/repeat_libraries/supplemental.lib
		  LC_ASSEMBLY_AGP		=> '', #/ecs4/work3/ba1/test/assembly/assembly.agp
		  LC_ASSEMBLY			=> '', #/ecs4/work3/ba1/test/assembly/assembly.bases    *unzipped name*
		  LC_SCAFFOLDS			=> '', #/ecs4/work3/ba1/test/assembly/scaffolds.fasta    *unzipped name*
		
		# Taxonomy
		  LC_DEFAULT	=> '', #ARMA    use a short name - look at ensj-healthcheck/src/org/ensembl/healthcheck/Species.java for ideas
		  LC_TAX_ID	    => '', #9361
		  LC_COMMON	    => '', #Nine-banded_armadillo    if your species has more than one common name these need to be inserted into the meta table manually		  
		  LC_TAXONOMY	=> [	{'species.classification' => '',},#novemcinctus
		  						{'species.classification' => '',},#Dasypus
		  						{'species.classification' => '',},#Dasypodidae
		  						{'species.classification' => '',},#Xenarthra
		  						{'species.classification' => '',},#Eutheria
		  						{'species.classification' => '',},#Theria
		  						{'species.classification' => '',},#Mammalia
		  						{'species.classification' => '',},#Euteleostomi
		  						{'species.classification' => 'Vertebrata',},
		  						{'species.classification' => 'Craniata',},	
		  						{'species.classification' => 'Chordata',},
		  						{'species.classification' => 'Eumetazoa',},
		...
		# RepeatMask-dependent analyses are run
		  LC_REPMASK_CHOICE		=>  [], #[ ('RepeatMask','Supp_RepeatMask') ]

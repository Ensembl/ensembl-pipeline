#!/usr/bin/env perl
# $Source: /tmp/ENSCOPY-ENSEMBL-PIPELINE/scripts/GeneComparison/compare_CDS.pl,v $
# $Revision: 1.3 $
...
$dna_db1->static_golden_path_type($ref_path2); 
...
$gene_comparison->compare_CDS(\@gene_clusters);

# MySQL dump 7.1
#
# Host: localhost    Database: ensembl07
#--------------------------------------------------------
...
CREATE TABLE contig (
  ...
  dna int(10) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE contigoverlap (
  dna_a_id int(10) unsigned DEFAULT '0' NOT NULL,
  dna_b_id int(10) unsigned DEFAULT '0' NOT NULL,
  ...
  KEY dna_a_index (dna_a_id),
  KEY dna_b_index (dna_b_id),
  KEY type_index (type)
);
...
CREATE TABLE feature (
  id int(10) unsigned DEFAULT '0' NOT NULL auto_increment,
  contig int(10) DEFAULT '0' NOT NULL,
  seq_start int(10) DEFAULT '0' NOT NULL,
  seq_end int(10) DEFAULT '0' NOT NULL,

...
use lib 't';
use EnsTestDB;
use Bio::EnsEMBL::Pipeline::RunnableDB::Clone_CPG;
...
my $runnable = 'Bio::EnsEMBL::Pipeline::RunnableDB::Clone_CPG';
...
{
    push (@islands, $contig->get_all_SimilarityFeatures());
}
display(@islands);

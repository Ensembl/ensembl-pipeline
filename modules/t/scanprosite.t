...
my $blastn = Bio::EnsEMBL::Pipeline::Runnable::Protein::ScanProsite->new('-query'    => $peptide,
							   '-program'  => '/analysis/iprscan/bin/scanprositef.pl',
							   '-database' => "$pwd/t/data/profile.dat",
							   '-workdir' => "$pwd/t/data",
							   '-parameters' => "$pwd/t/data/emotif.dat"		 );

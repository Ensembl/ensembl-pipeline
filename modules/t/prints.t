...
my $blastn = Bio::EnsEMBL::Pipeline::Runnable::Protein::Prints->new('-query'    => $peptide,
							   '-program'  => '/analysis/iprscan/bin/OSF1/FingerPRINTScan',
							   '-database' => "$pwd/t/data/prints.dat",
							   '-workdir' => "$pwd/t/data");

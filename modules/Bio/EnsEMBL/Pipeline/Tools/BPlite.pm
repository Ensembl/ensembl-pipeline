# $Id: BPlite.pm,v 1.3 2004-10-14 09:14:41 lec Exp $
##############################################################################
...
=head1 SYNOPSIS
 ...
 my $report = new Bio::EnsEMBL::Pipeline::Tools::BPlite(-fh=>\*STDIN);
...
create a new report, you pass a filehandle reference to the BPlite constructor.
 ...
 my $report = new Bio::EnsEMBL::Pipeline::Tools::BPlite(-fh=>\*STDIN); # or any other filehandle
...
#'
package Bio::EnsEMBL::Pipeline::Tools::BPlite;
...
use Bio::Root::IO;
use Bio::EnsEMBL::Pipeline::Tools::BPlite::Sbjct; # we want to use Sbjct
...
=head2 new
 ...
 Title   : new
 Function: Create a new Bio::EnsEMBL::Pipeline::Tools::BPlite object
 Returns : Bio::EnsEMBL::Pipeline::Tools::BPlite
...
=head2 next_feature
 ...
 Returns : A Bio::SeqFeatureI compliant object, in this case a
           Bio::EnsEMBL::Pipeline::Tools::BPlite::HSP object, and FALSE if there are no more
           HSPs.
 Args    : None

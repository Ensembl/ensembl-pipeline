  ...
  QUEUE_CONFIG => [
    {
      ...
      batch_size => 10,
      output_dir => '/lustre/scratch109/sanger/cgg/cdna_update_human83/output',
    ...
    },
    {
      ...
      batch_size => 10,
      output_dir => '/lustre/scratch109/sanger/cgg/cdna_update_human83/output2',
    ...
    },
    {
      ...
      batch_size => 1,
      output_dir => '/lustre/scratch109/sanger/cgg/cdna_update_human83/output3',
      resource => '-R"select[mem>4000] rusage[mem=4000, myens_build12tok=20:duration=5, myens_build12tok=20]" -M 4000',
      retries => 1,
      retry_resource => '-R"select[mem>4000] rusage[mem=4000, myens_build12tok=20:duration=5, myens_build12tok=20]" -M 4000'
    }

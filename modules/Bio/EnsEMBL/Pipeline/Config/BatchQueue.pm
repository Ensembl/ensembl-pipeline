  ...
  QUEUE_CONFIG => [
    {
      ...
      batch_size => 10,
      output_dir => '/lustre/scratch109/sanger/cgg/cdna_update_human81/output',
      resource => '-R"select[mem>2000] rusage[mem=2000, myens_build13tok=20:duration=5, myens_build13tok=20]" -M 2000',
      retries => 1,
      retry_resource => '-R"select[mem>4000] rusage[mem=4000, myens_build13tok=20:duration=5, myens_build13tok=20]" -M 4000'
    },
    {
      logic_name => 'cdna_update_2',
      batch_size => 10,
      output_dir => '/lustre/scratch109/sanger/cgg/cdna_update_human81/output2',
      resource => '-R"select[mem>4000] rusage[mem=4000, myens_build13tok=20:duration=5, myens_build13tok=20]" -M 4000',
      retries => 1,
      retry_resource => '-R"select[mem>4000] rusage[mem=4000, myens_build13tok=20:duration=5, myens_build13tok=20]" -M 4000'
    },
    {
      ...
      batch_size => 1,
      output_dir => '/lustre/scratch109/sanger/cgg/cdna_update_human81/output3',
      resource => '-R"select[mem>4000] rusage[mem=4000, myens_build13tok=20:duration=5, myens_build13tok=20]" -M 4000',
      retries => 1,
      retry_resource => '-R"select[mem>4000] rusage[mem=4000, myens_build13tok=20:duration=5, myens_build13tok=20]" -M 4000'
    }

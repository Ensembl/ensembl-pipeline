...
Bio::EnsEMBL::Pipeline::RunnableDB::cDNA_GeneBuilder

=head1 SYNOPSIS

    my $obj = Bio::EnsEMBL::Pipeline::RunnableDB::cDNA_GeneBuilder->new(
								       -dbobj     => $db,
								       -input_id  => $id
								      );
    $obj->fetch_input
...
package Bio::EnsEMBL::Pipeline::RunnableDB::cDNA_GeneBuilder;
...
=head2
 ...
 Function: this function is called from _merge_Transcripts and actually checks whether two transcripts
           inputs merge. For cDNAs we only consider one-2-one overlaps

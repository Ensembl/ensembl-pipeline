...
Bio::EnsEMBL::Pipeline::RunnableDB::Seg

=head1 SYNOPSIS

my $seg = Bio::EnsEMBL::Pipeline::RunnableDB::tRNAscan_SE->new ( -dbobj      => $db,
	  	                                                 -input_id   => $input_id
                                                                 -analysis   => $analysis );
...
This object wraps Bio::EnsEMBL::Pipeline::Runnable::Seg
...
package Bio::EnsEMBL::Pipeline::RunnableDB::Seg;

use strict;
use vars qw(@ISA);

use Bio::EnsEMBL::Pipeline::RunnableDB;
use Bio::EnsEMBL::Pipeline::Runnable::Seg;
...
=head2 new
 ...
 Function : creates a Bio::EnsEMBL::Pipeline::RunnableDB::Seg object
 Example  : 
 Returns  : a Bio::EnsEMBL::Pipeline::RunnableDB::Seg object
...
sub new {
    ...
    $self->runnable('Bio::EnsEMBL::Pipeline::Runnable::Seg');
    return $self;
}
...
sub write_output {
    my ($self) = @_;
    my $proteinFeatureAdaptor = $self->dbobj->get_ProteinFeatureAdaptor;
